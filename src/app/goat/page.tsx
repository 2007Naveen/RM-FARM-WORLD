      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-emerald-900 flex items-center gap-2">
            <Heart className="w-8 h-8 text-emerald-600 fill-emerald-600"/> வெள்ளாடுகள் & குட்டிகள் மேலாண்மை
          </h1>
          <p className="text-emerald-700 text-sm mt-1">
            சினை ஊசி கணக்கு (150 நாட்கள்), தடுப்பூசி & பல குட்டிகள் (Twins/Triplets) பதிவு
          </p>
        </div>
        ...
        >
          <Plus className="w-5 h-5"/> புதிய ஆடு / குட்டி சேர்க்க
        </button>
      </div>
      ...
      <div className="max-w-7xl mx-auto mb-6 flex border-b border-emerald-200">
        <button
          ...
          className={`pb-3 px-6 font-bold text-lg transition-all ${
            activeTab === "GOAT" ? "border-b-4 border-emerald-600 text-emerald-800" : "text-gray-500 hover:text-emerald-700"
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 px-6 font-bold text-lg transition-all ${
            activeTab === "KID" ? "border-b-4 border-emerald-600 text-emerald-800" : "text-gray-500 hover:text-emerald-700"
          }`}
        >
          ...
          {selectedGoat ? (
            <div className="bg-white rounded-2xl border border-emerald-100 p-6 shadow-sm">
              <div className="flex flex-wrap justify-between items-center border-b pb-4 mb-6 gap-3">
                <div>
                  <h2 className="text-2xl font-bold text-emerald-900">{selectedGoat.name}</h2>
              ...
              <div className="p-2">
                <div className="flex gap-6 items-center bg-emerald-50/50 p-4 rounded-xl mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-700 mt-1">மூலம்: <span className="text-emerald-900">{selectedGoat.source === "BORN_HERE" ? "பண்ணையில் பிறந்தவை" : "வாங்கப்பட்ட ஆடு"}</span></p>
                  </div>
                </div>
      ...
      {isKidBirthModalOpen && selectedGoat && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b pb-3 mb-4">
              <div>
                <h3 className="text-lg font-bold text-emerald-950">🐐 புதிய குட்டிகள் பதிவு</h3>
